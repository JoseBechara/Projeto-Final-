...
class Peca1(Peca):
    ...
    def move(self):
        ...
        if key[pygame.K_LEFT] and not self.click:
            self.click = True
            if not tab[x][y-1] == 1 and not tab[x+1][y-1] == 1 and not tab[x+2][y-1]:
                if self.rect.x >= 25:
                    self.rect.x -= 25
...
while not perdeu:
    ...
    if aleatorio == 3:
        if tab[x+2][y] == 1 or tab[x+2][y+1] == 1:
            # peca.vel_y = 0
            peca.caindo = False
            tab[x][y] = 1
            tab[x+1][y] = 1
    ...
    if aleatorio == 1:
        if tab[x+3][y] == 1 or tab[x+1][y+1] == 1 :
            peca.caindo = False
            tab[x][y] = 1
            tab[x+1][y] = 1
            tab[x][y+1] = 1
    ...
    if aleatorio == 2 :
        if tab[x+2][y] == 1 or tab[x+2][y+1] == 1 or tab[x+1][y+2] == 1 :
            peca.caindo = False
            tab[x][y+1] = 1
            tab[x][y+2] = 1
            tab[x+1][y] = 1
    ...
    if aleatorio == 4 :
        if tab[x+2][y] == 1 or tab[x+2][y+1] == 1 or tab[x+2][y+2] == 1 :
            peca.caindo = False
            tab[x+1][y] = 1
            tab[x+1][y+1] = 1
            tab[x+1][y+2] = 1
    ...
    if aleatorio == 5 :
       if tab[x+3][y] == 1 or tab[x+2][y+1] == 1 :
            peca.caindo = False
            tab[x+1][y] = 1
            tab[x+2][y] = 1
            tab[x][y+1] = 1
...
# -*- coding: utf-8 -*-
"""
Created on Thu Jun  7 01:15:13 2018
...
pygame.quit()
quit()
>>>>>>> c314c23804bc3f449fc6bab9e3b18cbcf3cd3117:tetris_matriz1.py
